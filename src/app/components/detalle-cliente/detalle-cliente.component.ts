...
displayedColumnsFactura: string[] = ['nombre', 'apellido', 'cedula','direccion', 'telefono','plan','estado', 'accion'];
dataSource;
data;
dataFactura;
...
applyFilter2(event: Event) {
  ...
  constructor(private activatedRoute: ActivatedRoute, public authService: AuthService, public usuarioService : UsuarioService, public facturaService: FacturaService, public clienteService: ClienteService,
...
getUsuario(){
  ...
  getContrato() {
    this.contratoService.getContrato(this.id)
      .subscribe(res => {
        ...
        this.data = new MatTableDataSource(this.contratoService.contratos);
 ...
 getFactura(){
   ...
   .subscribe(res =>{
    ...
    this.dataFactura = new MatTableDataSource(this.facturaService.facturas);
...
addServicio_contrato(form?: NgForm){
